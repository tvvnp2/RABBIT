...
def console(msg, end='\n', level=None):
    ...
    rando='SeRACHING NOW ...','sERACHING NOW ...','SErACHING NOW ...','SERaCHING NOW ...','SERAChING NOW ...','SERACHiNG NOW ...','SERACHInG NOW ...' , 'SERACHINg NOW ...','SERACHING nOW ...','SERACHING NoW ...','SERACHING NOw ...'
    code=random.choice(rando)
    
    print(f"\r    | [+] {Yellow}{code}{White}",end="")
